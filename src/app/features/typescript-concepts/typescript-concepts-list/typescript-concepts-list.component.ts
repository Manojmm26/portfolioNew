...
@Component({
  selector: 'app-typescript-concepts-list',
  standalone: true,
  imports: [
    CommonModule
    ,FormsModule,
  ...
  template: `
    <div class="list-container">
      <header class="list-header">
        <h1>Typescript Concepts ({{filteredConcepts.length}})</h1>
        <p>Master Typescript with interactive examples, live coding, and quizzes</p>
      </header>
...
export class TypescriptConceptsListComponent {
  concepts: TypescriptConcept[] = [];
  filteredConcepts: TypescriptConcept[] = [];
  searchQuery: string = '';
  ...
  navigateToConcept(conceptId: string) {
    this.router.navigate(['/typescript-concepts', conceptId]);
  }
