  ...
  template: `
    <div class="list-container">
      <header class="list-header">
        <h1>Java Concepts ({{filteredConcepts.length}})</h1>
        <p>Master Java with interactive examples, live coding, and quizzes</p>
      </header>
...
export class JavaListComponent implements OnInit {
  ...
  ngOnInit() {
    this.conceptService.getConcepts('java').subscribe(concepts => {
  ...
  navigateToConcept(conceptId: string) {
    this.router.navigate(['/java/concept', conceptId]);
  }
